...
@WebServlet({"/productos/editar","/productos/actualizar"})
public class ActualizarProductosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (codigo == null || codigo.isBlank()) {
            response.sendError(HttpServletResponse.SC_BAD_REQUEST,"Falta el parámetro con el código de producto a actualizar");
            return;
        }
        ...
        try {
            ...
            if (productoOpt.isEmpty()) {
                ...
                return; // OBSERVACIÓN!!! es necesario en un sendError...
            }
...
//            }
            ...
            // en una app multipágina lo ideal es navegar, por tanto enviar a error.jsp... y desde ahí poder navegar "Volver"
