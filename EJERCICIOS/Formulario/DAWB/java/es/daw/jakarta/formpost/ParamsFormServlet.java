...
//                        .collect(Collectors.joining("\n"));
                ...
                for (String lenguaje : lenguajes) {
                    ...
                    lenguajesHtml.concat("<li>"+lenguaje+"</li>\n");
                }

                // PENDIENTE HACER LO MISMO CON ROLES!!!!
                ...
                String htmlBody = """
                        ...
                        <li>Habilitar: %s</li>
                        <li>Secreto: %s</li>
                        """.formatted(username,password,email,lenguajesHtml,Arrays.toString(roles),habilitar,secreto);
