...
public class ParamsFormServlet2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // Aprenderá a hacerlo próximamente...
        // Damos por hecho que no hay error al guardar en BD
        String message="";
        if (errores != null && !errores.isEmpty()) {
            message ="Pedazo de error"; // simulando que todo a ido OK
        }else
            message ="Bienvenido al sistema, estos son tus datos"; // simulando que todo a ido OK
        ...
        // errores: es distinto de nulo si index2.jsp es llamada desde el servlet
        // errores: es nulo si index2.jsp es llamada desde el navegador
