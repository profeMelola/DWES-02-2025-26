...
<%
    ...
    // Si es nulo dejo los lenguajes por defecto (los que la página html tuviera marcados como selected a pelo
    // Los selected por defecto son java y spring
    String[] lenguajesVal = request.getParameterValues("lenguajes") !=null? request.getParameterValues("lenguajes"): new String[]{"java","spring"};


    //List<String> lista = Arrays.asList(lenguajesVal);
...
<%--                    <%}%>--%>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                ...
                <select name="lenguajes" id="lenguajes" multiple>
                    <option value="java" <%= Arrays.asList(lenguajesVal).contains("java")?"selected":""%> >Java SE</option>
                    <option value="jakartaee" <%= Arrays.asList(lenguajesVal).contains("jakartaee")?"selected":""%>>Jakarta EE9</option>
                    <option value="spring" <%= Arrays.asList(lenguajesVal).contains("spring")?"selected":""%>>Spring Boot</option>
        ...
        <div class="row mb-3">
            ...
            <div class="form-check col-sm-2">
                <input type="checkbox" name="roles" value="ROLE_ADMIN" class="form-check-input" ${paramValues.roles.stream().anyMatch(rol->rol.equals("ROLE_ADMIN"))?"checked":""}>
